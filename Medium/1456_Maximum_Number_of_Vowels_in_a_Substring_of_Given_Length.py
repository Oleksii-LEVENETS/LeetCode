...
assert Solution().max_vowels(s="abciiidef", k=3) == 3
assert Solution().max_vowels(s="aeiou", k=2) == 2
assert Solution().max_vowels(s="leetcode", k=3) == 2
print("OK assertion!")
